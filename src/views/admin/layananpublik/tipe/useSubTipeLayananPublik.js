...
const useSubTipeLayananPublik = (id, router) => {
  const BASE_URL = `${LAYANAN_PUBLIK_URL}/subtype`;
  ...
  const fetchAllData = async () => {
    try {
      ...
      const url = `${BASE_URL}/by-type/${id}?${filters.join("&")}`;
...
export default useSubTipeLayananPublik;
